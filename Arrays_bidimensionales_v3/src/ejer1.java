...
public class ejer1 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 6:
				Utilidades.mediaAsignatura(datos);
				break;
			case 7:
				Utilidades.nombreMediaMin(datos);
				break;
			case 8:
				Utilidades.nombreMediaMax(datos);
				break;
			case 9:
				Utilidades.nombreSuspensosMax(datos);
				break;
