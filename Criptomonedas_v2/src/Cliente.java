...
public class Cliente {
	...
	public boolean tieneCriptomoneda (String nombreCriptomoneda) {
		...
		for (int i = 0; i < this.billetera.getLineas_B().size(); i++) {
			if (this.billetera.getLineas_B().get(i).getCriptomoneda().getNombre().equalsIgnoreCase(nombreCriptomoneda)) {
				tieneCripto = true;
			}
		}
	...
	public int devolverPosLineaBCripto (String nombreCriptomoneda) {
		...
		for (int i = 0; i < this.getBilletera().getLineas_B().size(); i++) {
			if (this.getBilletera().getLineas_B().get(i).getCriptomoneda().getNombre().equalsIgnoreCase(nombreCriptomoneda)) {
				posLineaB = i;
			}
		}
