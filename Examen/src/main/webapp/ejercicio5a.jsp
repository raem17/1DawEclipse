...
<head>
	...
	ArrayList<Equipo> equipos = conexion.dameTodosEquipos();
	%>
					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form style="display: flex; flex-direction: column; gap: 1rem;" action="ejercicio5b.jsp" method="post">
									<select name="nombre">
										<% for(int i = 0; i < equipos.size(); i++) { %>
											<option value="<%=equipos.get(i).getNombre() %>"><%=equipos.get(i).getNombre() %></option>
										<%} %>
									</select>
