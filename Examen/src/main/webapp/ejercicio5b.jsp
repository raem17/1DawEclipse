...
<head>
	...
	Equipo equipoSelected = conexion.dameEquipo(nombreEquipo);
	%>
					...
					<div class="container">
						<div id="content">
							...
							<article>
								...
								<form style="display: flex; flex-direction: column; gap: 1rem;" action="operaciones.jsp?tipo=modificarEquipo&nombre=<%=equipoSelected.getNombre() %>" method="post">
									
									<input type="text" name="ciudad" placeholder="Ciudad" value="<%=equipoSelected.getCiudad() %>">
