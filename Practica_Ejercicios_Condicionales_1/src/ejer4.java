...
public class ejer4 {
	...
	public static void main(String[] args) {
		...
		if (res > 5000) {
			System.out.println("La suma de todos los salarios suman más de 5000€ mensuales.");
		}
		
		else if (res < 5000) {
			System.out.println("La suma de todos los salarios no suman más de 5000€ mensuales.");
		}
		
		else {
			System.out.println("La suma de todos los salarios es igual a 5000€ mensuales.");
		}
