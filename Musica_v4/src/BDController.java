...
public class BDController {
	...
	public ArrayList<String> devolverNombresArtistasXGrupo (String nombreGrupo) {
		ArrayList<String> nombresArtistas = new ArrayList<String>();
		
		String sql = "SELECT artista.nombre FROM artista, pertenece, grupo "
				+ "where artista.dni = pertenece.dni "
				+ "AND pertenece.cod = grupo.cod "
		...
		try {
			...
			while(rs.next() == true) {
				nombresArtistas.add(rs.getString("nombre"));
			}
			
			miStatement.close();
			rs.close();
		} catch (Exception e) {
			System.out.println("Error en devolverNombresArtistasXGrupo: " + e);
		}
		
		return nombresArtistas;
	}
	
	public ArrayList<String> devolverTituloDiscosMin7Canciones () {
		...
		try {
			...
			while(rs.next() == true) {
				titulosDiscos.add(rs.getString("nombre"));
			}
			
			miStatement.close();
			rs.close();
		} catch (Exception e) {
			System.out.println("Error en devolverTituloDiscosMin7Canciones: " + e);
		}
		
		return titulosDiscos;
	}
	
	public ArrayList<String> devolverTituloCancionesEnNingunDisco () {
		ArrayList<String> titulosCanciones = new ArrayList<String>();
		...
		try {
			...
			while(rs.next() == true) {
				titulosCanciones.add(rs.getString("titulo"));
			}
			
			miStatement.close();
			rs.close();
		} catch (Exception e) {
			System.out.println("Error en devolverTituloCancionesEnNingunDisco: " + e);
		}
		
		return titulosCanciones;
	}
	
	public ArrayList<String> devolverNombresArtistasEnNingunGrupo () {
		...
		try {
			...
			System.out.println("Error en devolverNombresArtistasEnNingunGrupo: " + e);
		}
