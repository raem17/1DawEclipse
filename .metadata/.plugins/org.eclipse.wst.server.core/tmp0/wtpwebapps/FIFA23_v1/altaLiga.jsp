							...
							<!-- Content -->
								...
								<form action="operaciones.jsp?tipo=altaLiga" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombreLiga" id="nombreLiga" placeholder="Nombre de la liga" style="width:450px"; maxlength="30"/>
										</div>
										<div class="">
											<input type="text" name="nombrePais" id="nombrePais" placeholder="Nombre del país de la liga" maxlength="20"/>
										</div>
