...
public class ejer2 {
	...
	public static void main(String[] args) {
		...
		// Se rellena el array 3 con las posiciones inversas del array 1
		for (int i = 0, j = numeros1.length-1; i < numeros1.length; i++, j--) {
			numeros3 [i] = numeros1 [j];
		}
		
		// Se rellena el resto del array 3 con las posiciones inversas del array 2, para eso creo una variable j para las posiciones del array 2.
		for (int i = numeros1.length, j = numeros2.length-1; i < (numeros1.length + numeros2.length); i++, j--) {
