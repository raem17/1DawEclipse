...
public class Estadistica {
	...
	public void imprimirDatos() {
		...
		System.out.println("Tarjetas amarillas: " + this.tarjetas_a);
		System.out.println("Tarjetas rojas: " + this.tarjetas_r);
		System.out.println("Partidos jugados: " + this.partidos_j);
		System.out.println("Titularidades: " + this.titularidades);
		System.out.println("Minutos jugados: " + this.minutos_jugados + "\n");
	}
	
	public int tarjetasTotal() {
		int numTarjetasTotal = this.tarjetas_a + this.tarjetas_r;
		
		return numTarjetasTotal;
	}
