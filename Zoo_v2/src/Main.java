...
public class Main {
	...
	public static void main(String[] args) {
		...
		crearTXTSiNoExiste(archivo);
		volcarTXTSobreArrayAnimales(datosAnimales, archivo);
		...
		do {
			...
			case 5: modificarAtributosExclusivosAnimal(datosAnimales);
				...
				break;
			case 6: generarArchivoXEspecie(datosAnimales);
		...
		volcarArrayAnimalesSobreTXT(datosAnimales, archivo);
	...
	public static void mostrarMenu() {
		...
		System.out.println("6.	Genera un archivo de texto con un listado de animales de una especie.");
	...
	public static void modificarAtributosExclusivosAnimal(ArrayList<Animal> datosAnimales) {
		...
		if (existeAnimal(nombre, datosAnimales)) {
			...
			String claseAnimal = devolverClaseAnimal(datosAnimales.get(posicion));
			
			if (claseAnimal.equalsIgnoreCase("Bufalo")) {
			...
			} else if (claseAnimal.equalsIgnoreCase("Hiena")) {
			...
			} else if (claseAnimal.equalsIgnoreCase("Hipopotamo")) {
			...
			} else if (claseAnimal.equalsIgnoreCase("Jirafa")) {
			...
			} else if (claseAnimal.equalsIgnoreCase("Leon")) {
			...
			} else if (claseAnimal.equalsIgnoreCase("Tigre")) {
	...
	public static String devolverClaseAnimal (Animal datosAnimal) {
		String claseAnimal = datosAnimal.getClass().toString().replace(" ", "");
		claseAnimal = claseAnimal.replace("class", "");
	...
	public static void crearTXTSiNoExiste(File archivo) {
		if (!archivo.exists()) {
			try {
	...
	public static void volcarArrayAnimalesSobreTXT(ArrayList<Animal> datosAnimales, File archivo) {
		try {
			BufferedWriter bw = new BufferedWriter(new FileWriter(archivo, false));
			
			for (int i = 0; i < datosAnimales.size(); i++) {
				String claseAnimal = devolverClaseAnimal(datosAnimales.get(i));
				
				if (claseAnimal.equalsIgnoreCase("bufalo")) {
					Bufalo bufalo = (Bufalo)datosAnimales.get(i);
					
					bw.write("Búfalo:" + bufalo.getNombre() + ":" + bufalo.getProcedencia() + ":" + bufalo.getAltura() + ":" + 
							bufalo.getPeso() + ":" + bufalo.getAltura_cuernos() + ":" + bufalo.esPeludo());
					
				} else if (claseAnimal.equalsIgnoreCase("hiena")) {
					Hiena hiena = (Hiena)datosAnimales.get(i);
					
					bw.write("Hiena:" + hiena.getNombre() + ":" + hiena.getProcedencia() + ":" + hiena.getAltura() + ":" + 
							hiena.getPeso() + ":" + hiena.getVelocidad() + ":" + hiena.getNivel_risa());
					
				} else if (claseAnimal.equalsIgnoreCase("hipopotamo")) {
					Hipopotamo hipo = (Hipopotamo)datosAnimales.get(i);
					
					bw.write("Hipopótamo:" + hipo.getNombre() + ":" + hipo.getProcedencia() + ":" + hipo.getAltura() + ":" + 
							hipo.getPeso() + ":" + hipo.getNum_dientes() + ":" + hipo.getAltura_orejas() + ":" + hipo.getNivel_agresividad());
					
				} else if (claseAnimal.equalsIgnoreCase("jirafa")) {
					Jirafa jirafa = (Jirafa)datosAnimales.get(i);
					
					bw.write("Jirafa:" + jirafa.getNombre() + ":" + jirafa.getProcedencia() + ":" + jirafa.getAltura() + ":" + 
							jirafa.getPeso() + ":" + jirafa.getLongitud_pestañas() + ":" + jirafa.getNum_manchas());
					
				} else if (claseAnimal.equalsIgnoreCase("leon")) {
					Leon leon = (Leon)datosAnimales.get(i);
					
					bw.write("León:" + leon.getNombre() + ":" + leon.getProcedencia() + ":" + leon.getAltura() + ":" + 
							leon.getPeso() + ":" + leon.getNivel_fuerza() + ":" + leon.getNivel_rugido() + ":" + leon.esAgresivo());
					
				} else if (claseAnimal.equalsIgnoreCase("tigre")) {
					Tigre tigre = (Tigre)datosAnimales.get(i);
					
					bw.write("Tigre:" + tigre.getNombre() + ":" + tigre.getProcedencia() + ":" + tigre.getAltura() + ":" + 
							tigre.getPeso() + ":" + tigre.getColor() + ":" + tigre.getNum_rallas());
					
				} // else no necesario
				
				// salto de linea si no es la ultima posision
			...
			System.out.println("Error en volcarArrayAnimalesEnTXT: " + e);
		}
		
	}
	
	public static void volcarTXTSobreArrayAnimales(ArrayList<Animal> datosAnimales, File archivo) {
		String linea = "";
		...
		try {
			BufferedReader br = new BufferedReader(new FileReader(archivo));
			 ...
			 try {
				...
				while (linea != null) {
					String especie = linea.split(":")[0];
					
					if (especie.equalsIgnoreCase("Búfalo")) {
						boolean esPeludo = false;
						if (linea.split(":")[6].equalsIgnoreCase("Peludo")) {
							esPeludo = true;
						}
						
						Bufalo bufalo = new Bufalo(linea.split(":")[1], linea.split(":")[2], Integer.parseInt(linea.split(":")[3]), 
								Double.parseDouble(linea.split(":")[4]), Integer.parseInt(linea.split(":")[5]), esPeludo);
						
						datosAnimales.add(bufalo);
						
					} else if (especie.equalsIgnoreCase("Hiena")) {
						Hiena hiena = new Hiena(linea.split(":")[1], linea.split(":")[2], Integer.parseInt(linea.split(":")[3]), 
								Double.parseDouble(linea.split(":")[4]), Integer.parseInt(linea.split(":")[5]), Integer.parseInt(linea.split(":")[6]));
						
						datosAnimales.add(hiena);
						
					} else if (especie.equalsIgnoreCase("Hipopótamo")) {
						Hipopotamo hipo = new Hipopotamo(linea.split(":")[1], linea.split(":")[2], Integer.parseInt(linea.split(":")[3]), 
								Double.parseDouble(linea.split(":")[4]), Integer.parseInt(linea.split(":")[5]), Integer.parseInt(linea.split(":")[6]), 
						...
						Jirafa jirafa = new Jirafa(linea.split(":")[1], linea.split(":")[2], Integer.parseInt(linea.split(":")[3]), 
								Double.parseDouble(linea.split(":")[4]), Integer.parseInt(linea.split(":")[5]), Integer.parseInt(linea.split(":")[6]));
						
						datosAnimales.add(jirafa);
						
					} else if (especie.equalsIgnoreCase("León")) {
						boolean esAgresivo = false;
						if (linea.split(":")[7].equalsIgnoreCase("Agresivo")) {
							esAgresivo = true;
						}
						
						Leon leon = new Leon(linea.split(":")[1], linea.split(":")[2], Integer.parseInt(linea.split(":")[3]), 
								Double.parseDouble(linea.split(":")[4]), Integer.parseInt(linea.split(":")[5]), Integer.parseInt(linea.split(":")[6]), esAgresivo);
						
						datosAnimales.add(leon);
						
					} else if (especie.equalsIgnoreCase("Tigre")) {
						Tigre tigre = new Tigre(linea.split(":")[1], linea.split(":")[2], Integer.parseInt(linea.split(":")[3]), 
								Double.parseDouble(linea.split(":")[4]), linea.split(":")[5], Integer.parseInt(linea.split(":")[6]));
						
						datosAnimales.add(tigre);
			...
			System.out.println("Error en volcarTXTSobreArrayAnimales: " + e);
		}
	}
	
	public static void generarArchivoXEspecie (ArrayList<Animal> datosAnimales) {
		Scanner scnum = new Scanner(System.in);
		Scanner sctxt = new Scanner(System.in);
