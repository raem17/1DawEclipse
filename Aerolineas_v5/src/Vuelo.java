...
public class Vuelo {
	...
	public Vuelo(int cod_vuelo, Avion datosAvion, Pasajero[] datosPasajeros, Aeropuerto aeropuerto_salida,
	...
	public Avion getDatosAvion() {
		return datosAvion;
	}


	public void setDatosAvion(Avion datosAvion) {
		this.datosAvion = datosAvion;
	}
