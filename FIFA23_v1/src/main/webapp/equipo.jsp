						...
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									<header>
										<table >
											...
											<tr style="border:0px;" >	
												<td width='3%' style="background-color: white"><img src= 'images/equipos/<%=codEquipo%>.png' style="padding: 0.25rem;float: left; position: relative;width: 10%"></img></td>
											</tr>
										
											<tr style="border:0px;" >	
												<td style="background-color: white;"><h2 style="margin: 0"><%=nombreEquipo%></h2></td>
											</tr>
								...
								<table class="alt">
									...
									ArrayList<Jugador> jugas = conexion.devolverJugadoresXCodEquipo(codEquipo);
									...
									for(int i = 0; i < jugas.size(); i++) {
										...
										out.print("<td width='325' colspan='3' style='padding-left: 15px;font-weight: bold;'>" + jugas.get(i).getNombre() + "</td>");
										...
										out.print("</tr>" +
												...
												// foto equipo
												  "<td width='3%'><img src = 'images/equipos/"+ jugas.get(i).getCod_equipo() +".png' style='float: none; position: relative; width: 100%;padding:0.25rem;'></td>" +
												
												// foto pais
												  "<td width='3%'><img src = 'images/paises/"+ jugas.get(i).getPais() +".png' style='float: left; position: relative; width: 100%;padding:0.25rem;'></td>" +
												
												// foto liga
												  "<td width='90'><img src = 'images/ligas/"+ conexion.dameCodLigaXCodEquipo(jugas.get(i).getCod_equipo()) +".png' style='float: left; position: relative; width: 13%;padding:0.25rem;'></td>" +
