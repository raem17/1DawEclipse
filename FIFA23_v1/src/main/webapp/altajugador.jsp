					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form action="operaciones.jsp?tipo=altaJuga" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombreJuga" id="nombreJuga" placeholder="Nombre del jugador" style="width:450px"; maxlength="50"/>
										</div>
										<div class="">
											<label>Pierna</label>
										...
										<div class="">
											...
											for(int i = 0; i < equipos.size(); i++) { %>
												<!-- 3 -->
												<option data-img_src="images/equipos/<%=equipos.get(i).getCod_equipo() %>.png" value="<%=equipos.get(i).getCod_equipo()%>"><%=equipos.get(i).getNombre() %></option>
											<%}; %>
											</select>											
										</div>
										<div class="">
											<input type="text" name="paisJuga" id="paisJuga" placeholder="País del jugador" maxlength="20"/>
										</div>
										<div class="">
											<input type="number" name="alturaJuga" id="alturaJuga" placeholder="Altura del jugador" maxlength="11"/>
										</div>
