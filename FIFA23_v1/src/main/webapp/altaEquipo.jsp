							...
							<!-- Content -->
								...
								<form action="operaciones.jsp?tipo=altaEquipo" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombreEquipo" id="nombreEquipo" placeholder="Nombre del equipo" style="width:450px"; maxlength="30"/>
										</div>
										...
										<div class="">
											...
											<!-- 3 -->
												<option data-img_src="images/ligas/<%=ligas.get(i).getCod_liga() %>.png" value="<%=ligas.get(i).getCod_liga()%>"><%=ligas.get(i).getNombre() %></option>
											<%}; %>
											</select>
										</div>
