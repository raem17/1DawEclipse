					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								ArrayList<Jugador> jugadores = conexion.todosJugadores();
								%>
								
								<form action="operaciones.jsp?tipo=bajaJuga" method="post">
									<div class="row gtr-50">
										<div class="">
											<!-- 2 -->
											<select id="id_select2_example" name="codJuga">
											<%
											for(int i = 0; i < jugadores.size(); i++) { %>
												<option data-img_src="images/jugadores/<%=jugadores.get(i).getCod_jugador() %>.png" value="<%=jugadores.get(i).getCod_jugador()%>"><%=jugadores.get(i).getNombre() %></option>
											<%}; %>
											</select>
										</div>
