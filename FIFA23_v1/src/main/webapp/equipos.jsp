									...
									<tbody>
											<%
																				...
																				for (int i = 0; i < equipos.size(); i++) {
																					...
																					// nombre
																					out.print("<td width='10%' colspan='3' style='padding-left: 15px; font-weight:bold; color:#B93A4B; font-size: 1rem;'><a href = 'equipo.jsp?codEquipo=" + equipos.get(i).getCod_equipo() + "&nombreEquipo=" + equipos.get(i).getNombre()+"'>"+ equipos.get(i).getNombre() + "</a></td>");
																					...
																					// foto liga
																					Liga ligaDeEquipo = conexion.dameLiga(equipos.get(i).getCod_liga());
																					out.print("<td width='50' style='text-align: left; padding-left: 0px;  padding-top: 0px;  padding-bottom: 0px;'><a href = 'liga.jsp?cod_liga="+ ligaDeEquipo.getCod_liga() +"&nombreLiga="+ ligaDeEquipo.getNombre() +"'><img src = 'images/ligas/"+ ligaDeEquipo.getCod_liga() + ".png' style='float: left; position: relative; width: 100%; padding: 0.25rem;'></a></td>");
