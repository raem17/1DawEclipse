					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								Liga liga = conexion.dameLiga(codLiga);
								
								%>
								
								<form action="operaciones.jsp?tipo=modificarLiga&codLiga=<%=codLiga %>" method="post">
									<div class="row gtr-50">
										<div class="">
											<input value="<%=liga.getNombre() %>" type="text" name="nombreLiga" id="nombreLiga" placeholder="Nombre de la liga" style="width:450px"; maxlength="30"/>
										</div>
										<div class="">
											<input value="<%=liga.getPais() %>" type="text" name="nombrePais" id="nombrePais" placeholder="Nombre del país de la liga" maxlength="20"/>
										</div>
